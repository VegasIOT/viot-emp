...
#define light_state_topic "bruh/emp"
#define light_set_topic "bruh/emp/set"
...
const byte interruptPinA = A0;
volatile byte interruptCounterA = 0;
...
void setup() {
  ...
  //attachInterrupt(digitalPinToInterrupt(interruptPinA), handleInterruptA, CHANGE);
...
void sendState() {
  ...
  root["emp"] = (String)motionStatus;
  root["empa"] = (String)LDR;
